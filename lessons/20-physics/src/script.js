...
const playHitSound = (collision) => {
  ...
  if (impactStrength > 1) {
    let newVolume = Math.min(1, impactStrength / 10);
    hitSound.volume = newVolume;
...
//   // Create a physics body for the text
//   const shape = CannonPhysics.createConvexPolyhedron(geometry);
//   const body = new CannonPhysics.Body({
//     mass: 1,
//     shape: shape,
//   });
